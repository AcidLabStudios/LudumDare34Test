...
public class Hud implements Disposable {
    ...
    public void update() {
        ...
        if (exitPartsCount == 5) {
            this.exitPartsLabel.setStyle(new Label.LabelStyle(new BitmapFont(), Color.YELLOW));
        } else {
            this.exitPartsLabel.setStyle(new Label.LabelStyle(new BitmapFont(), Color.FIREBRICK));
        }
